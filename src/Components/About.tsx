...
export const About = React.forwardRef<HTMLDivElement, MotionSectionProps>(
  (props, ref) => {
      ...
      >
        <GlassCard>
          <p>
            ...
            systems on AWS, and <a href="https://www.gibbly.co">Gibbly</a>, an
            AI edtech platform I co-founded and am the sole developer for, now
            serving roughly 36,000 students and educators.
          </p>
          <p>
            ...
            while completing my Electrical Engineering degree at TMU, followed
            by game development at Ripple Studios.
          </p>
