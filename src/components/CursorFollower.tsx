...
export default function CursorFollower(props: ICursorFollowerProps) {
  ...
  return (
    <div
      id="gradient-box"
      className="top-0 left-0 z-0 fixed bg-radial from-primary/85 via-primary/8 to-primary/0 opacity-30 dark:opacity-5 rounded-full w-150 h-150 transition-opacity duration-200 ease-in-out pointer-events-none"
    ></div>
  );
}
